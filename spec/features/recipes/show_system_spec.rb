...
#       @recipe = Recipe.create(name: 'French macaroons', preparation_time_hours: '1.00', cooking_time_hours: '1.00',
...
#     it 'should display recipe preparation time in hours' do
#       expect(page).to have_content("Preparation time: #{@recipe.preparation_time_hours} hours")
#     end

#     it 'should display recipe preparation time in hours' do
#       expect(page).to have_content("Cooking time: #{@recipe.cooking_time_hours} hours")
#     end
