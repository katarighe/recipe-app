...
RSpec.describe 'Foods', type: :system do
  ...
  context 'add a new food page' do
    ...
    it 'should display error messages on price (in dollars) less than or equal to zero' do
      visit foods_path
      click_link('Add Food')
      fill_in 'Name', with: 'Orange'
      fill_in 'Measurement unit', with: ''
      ...
      expect(page).to have_content('Price (in dollars) must be greater than 0.00')
    end
  end
end
