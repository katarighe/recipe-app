...
RSpec.describe 'Recipes', type: :system do
  context 'sign up page' do
    ...
    it 'should display an error if password is less than 6 characters' do
    ...
    it 'should display an error if password doesn\'t match password confirmation' do
      fill_in('Email', with: 'pedro@domain.com')
      fill_in('Name', with: 'Pedro Guerreiro')
    ...
    it 'should display all the links' do
      find_link('Log in')
